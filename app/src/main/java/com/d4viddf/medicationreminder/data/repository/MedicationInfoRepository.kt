...
import com.d4viddf.medicationreminder.data.model.CimaDocumento
import com.d4viddf.medicationreminder.data.model.CimaEstado
import com.d4viddf.medicationreminder.data.model.CimaFormaFarmaceutica
...
import com.d4viddf.medicationreminder.data.model.CimaViaAdministracion
    ...
    suspend fun searchMedication(query: String): List<MedicationSearchResult> = withContext(ioDispatcher) {
        ...
        while (moreResults) {
            ...
            for (i in 0 until resultsArray.length()) {
                ...
                // Extracting fotos
                val fotosJsonArray = resultJson.optJSONArray("fotos")
                val fotosList = parseJsonArrayToList(fotosJsonArray) { fotoJson ->
                    CimaFoto(
                ...
                val searchResult = MedicationSearchResult(
                    ...
                    generico = generico,
                    imageUrl = fotosList // Assign the list of CimaFoto
                )
