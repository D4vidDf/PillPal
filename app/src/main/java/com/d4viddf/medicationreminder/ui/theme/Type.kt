...
val AppTypography = Typography(
    ...
    headlineSmall = baseline.headlineSmall.copy(fontFamily = displayFontFamily, fontWeight = FontWeight.Bold, fontSize = 20.sp),
    titleLarge = baseline.titleLarge.copy(fontFamily = displayFontFamily, fontWeight = FontWeight.Normal, fontSize = 16.sp, color = Color.Gray),
    ...
    bodyMedium = baseline.bodyMedium.copy(fontFamily = bodyFontFamily, fontWeight = FontWeight.Normal, fontSize = 14.sp, color = Color.DarkGray),
