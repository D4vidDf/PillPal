...
import com.d4viddf.medicationreminder.ui.common.theme.AppTheme // Assuming AppTheme, adjust if MedicationReminderTheme is used
...
fun NotificationToggleWidget(
    ...
    Row(
        ...
        Text(text = stringResource(id = R.string.notifications_toggle_label), modifier = Modifier.weight(1f))
        Switch(
